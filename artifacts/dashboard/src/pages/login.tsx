      ...
      { data: values },
      {
        ...
        onError: (error: ErrorType<unknown>) => {
          ...
          toast({
            ...
            description: msg || "Credenciales inválidas. Inténtalo de nuevo.",
          });
        },
      }
    );
      ...
      <div className="w-full max-w-md z-10">
        <div className="bg-card border border-border rounded-lg shadow-xl overflow-hidden flex flex-col">
          <div className="p-8 pb-6 border-b border-border/50 bg-secondary/30 text-center">
            ...
            <p className="text-sm text-muted-foreground font-mono">SOLO PERSONAL AUTORIZADO</p>
          </div>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-xs uppercase tracking-wider font-mono text-muted-foreground">Correo Electrónico</FormLabel>
                      <FormControl>
                        <Input 
